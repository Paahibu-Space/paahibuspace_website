...
class WorksController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.works.work-index')->with(['all_works' => $all_works, 'works_category' => $work_category]);
    }
    ...
    public function new()
    {
        ...
        return view('backend.works.new-work')->with([ 'works_category' => $work_category]);
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.works.edit-work')->with([ 'work_details' => $work_details, 'works_category' => $work_category]);
    }
    ...
    public function category_index()
    {
        ...
        return view('backend.works.category')->with(['all_category' => $all_category]);
    }
    ...
    public function slug_check(SlugCheckRequest $request){
        ...
        $query = UpcomingPrograms::Works(['slug' => $user_given_slug]);
