        ...
        <div class="row gy-4">
            ...
            <div class="col-lg-6 order-2 order-lg-1 content">
                ...
                <ul class="program-components">
                    <li><i class="bi bi-check2-all"></i> <span>Digitally brand and position businesses for visibility and credibility</span></li>
                    <li><i class="bi bi-check2-all"></i> <span>Practical skills in social media marketing, content creation & customer engagement</span></li>
        ...
        <div class="row align-items-center justify-content-center">
            ...
            <div class="col-lg-6">
                <div class="about__content-six">
                    ...
                    <p>
                        Despite the rise of digital entrepreneurship, many women-led businesses remain digitally invisible. 
                        Barriers like lack of training, low awareness of e-commerce, and limited access to resources prevent them 
                        from fully leveraging the online economy.
                    </p>
                    <div class="about__content-inner-four">
                        <div class="about__list-box">
                            <ul class="list-wrap">
                                <li><i class="bi bi-arrow-right"></i> Fewer than 20% of women-led MSMEs leverage digital platforms (UN Women)</li>
                                <li><i class="bi bi-arrow-right"></i> Limited access to branding, cybersecurity, and e-commerce skills</li>
                                <li><i class="bi bi-arrow-right"></i> Barriers to in-person training (location, caregiving, cost)</li>
                                <li><i class="bi bi-arrow-right"></i> Missed opportunities to market, sell, and scale using digital tools</li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="row align-items-center justify-content-center">
            <div class="col-lg-6 margin-bottom-30">
                <div class="choose__content-five">
                    ...
                    <p>
                        WiDiB aims to strengthen the digital competitiveness of women-led MSMEs, ensuring they gain the skills, 
                        confidence, and tools to thrive online and scale sustainably.
                    </p>
                            ...
                            <div class="col-sm-6">
                                <div class="choose__box">
                                    <div class="content">
                                        ...
                                        <p>Train 500+ women entrepreneurs in digital skills by end of 2025</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="choose__box">
                                    <div class="content">
                                        ...
                                        <p>Ensure at least 70% implement a digital strategy within 3 months</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="choose__box">
                                    <div class="content">
                                        ...
                                        <p>Support 30% to launch or improve their online presence</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="choose__box">
                                    <div class="content">
                                        ...
                                        <p>Increase digital safety, competitiveness, and access to new markets</p>
                                    </div>
                                </div>
                            </div>
                        </div>
