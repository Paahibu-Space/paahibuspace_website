...
@section('site-title')
    {{__('Registration')}} {{$program->title}}
@endsection
@section('page-title')
    {{__('Registration')}} {{$program->title}}
@endsection
@section('page-meta-data')
    <meta name="description" content="{{get_static_option($program->meta_tags)}}">
    <meta name="tags" content="{{get_static_option($program->meta_description)}}">
@endsection
@section('content')
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="program-registration-form">
                        <h4>{{get_static_option('program_registration_page_title')}}</h4>
                       <x-error-msg/>
                        <x-flash-msg/>
                        <div class="order-tab-wrap">
                            ...
                            <div class="tab-content" >
                                ...
                                <div class="tab-pane fade @if(auth()->check()) show active @endif" id="nav-profile" role="tabpanel">
                                    ...
                                    @endif
                                    <form method="post" action="{{route('frontend.program.registration.store')}}" enctype="multipart/form-data">
                                        ...
                                        @if(!empty($program->cost) && $program->cost > 0)
                                            {!! render_payment_gateway_for_form() !!}
                                        @endif
                                        <div class="btn-wrapper">
                                            <button type="submit" class="btn-boxed style-01">{{get_static_option('program_registration_page_form_button_title')}}</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
