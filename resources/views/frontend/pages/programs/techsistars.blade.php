    ...
    <div class="container aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
        <div class="row gy-4">
            <div class="col-lg-6 order-1 order-lg-2">
                <img src="{{ asset('assets/frontend/images/techsistars.webp') }}" class="img-fluid" alt="TechsiStars Program"><br><br>
                                <p>
                    <span class="fw-bold">TechsiStars</span> is a 3-month hybrid (virtual + in-person) mentorship bootcamp 
                    designed for girls aged 16–25. It combines one-on-one mentorship, group learning, and expert-led sessions 
                    to help participants develop confidence, skills, and career readiness. The program is inclusive and accessible, 
                    particularly for underrepresented and rural communities.
                </p>
            </div>
            <div class="col-lg-6 order-2 order-lg-1 content">
                <h2 class="title">TechsiStars Mentorship Bootcamp</h2>
                <p class="fst-italic">
                    TechsiStars is a hybrid mentorship and capacity-building bootcamp that connects aspiring girls 
                    with established women in technology. It provides mentorship, practical skills, and career guidance, 
                    fostering the next generation of confident and capable female tech leaders.
                </p>
                <h5 class="fw-bold">What participants gain:</h5>
                <ul class="program-components">
                    <li><i class="bi bi-check2-all"></i> <span>Be matched with experienced female mentors in diverse tech fields</span></li>
                    <li><i class="bi bi-check2-all"></i> <span>Explore career paths in software development, product design, data, AI, and cybersecurity</span></li>
                    <li><i class="bi bi-check2-all"></i> <span>Participate in hands-on workshops, tech challenges, and guided projects</span></li>
                    <li><i class="bi bi-check2-all"></i> <span>Receive mentorship on leadership, personal growth, and overcoming gender barriers</span></li>
                    <li><i class="bi bi-check2-all"></i> <span>Build professional portfolios, LinkedIn profiles, and tech-ready resumes</span></li>
                    <li><i class="bi bi-check2-all"></i> <span>Discover scholarships, internships, and remote work opportunities</span></li>
                    <li><i class="bi bi-check2-all"></i> <span>Join a supportive network of mentors and peers for long-term growth</span></li>
                </ul>
        ...
        <div class="row align-items-center justify-content-center">
            <div class="col-lg-6 col-md-8">
                <div class="about__img-wrap-six">
                    <img src="{{ asset('assets/frontend/images/techsistars2.webp') }}"
                        data-bb-lazy="true" loading="lazy"
                        data-src="{{ asset('assets/frontend/images/techsistars2.webp') }}"
                        alt="TechsiStars Need" data-ll-status="loaded" class="entered loaded">
                </div>
            </div>
            <div class="col-lg-6">
                <div class="about__content-six">
                    ...
                    <p>
                        Despite Africa’s growing digital economy, women remain underrepresented in STEM and tech careers. 
                        TechsiStars creates a nurturing and skill-driven pathway for girls and young women to explore and thrive in technology.
                    </p>
                    <div class="about__content-inner-four">
                        <div class="about__list-box">
                            <ul class="list-wrap">
                                <li><i class="bi bi-arrow-right"></i> Limited mentorship and role models for girls in tech</li>
                                <li><i class="bi bi-arrow-right"></i> Lack of practical training and career guidance</li>
                                <li><i class="bi bi-arrow-right"></i> Persistent stereotypes and societal barriers</li>
                                <li><i class="bi bi-arrow-right"></i> Low awareness of diverse tech career opportunities</li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="row align-items-center justify-content-center">
            <div class="col-lg-6 margin-bottom-30">
                <div class="choose__content-five">
                    ...
                    <p>
                        TechsiStars aims to bridge the gender gap in technology, building a supportive sisterhood of girls and women in tech, 
                        and equipping participants with the skills, mentorship, and confidence to excel in their careers.
                    </p>
                            ...
                            <div class="col-sm-6">
                                <div class="choose__box">
                                    <div class="content">
                                        ...
                                        <p>Connect 100+ girls annually with experienced female mentors</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="choose__box">
                                    <div class="content">
                                        ...
                                        <p>Provide hands-on experience in coding, UI/UX, and data skills</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="choose__box">
                                    <div class="content">
                                        ...
                                        <p>Open access to scholarships, internships, and tech entrepreneurship</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="choose__box">
                                    <div class="content">
                                        <h4 class="title">Sisterhood</h4>
                                        <p>Foster a long-term support network of aspiring and established women in tech</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-lg-6 col-md-9 margin-bottom-30">
                <div class="choose__img-wrap-five">
                    <img src="{{ asset('assets/frontend/images/stay-inspired.webp') }}"
                        data-bb-lazy="true" loading="lazy"
                        data-src="{{ asset('assets/frontend/images/stay-inspired.webp') }}"
                        alt="TechsiStars Goals" data-ll-status="loaded" class="entered loaded">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 margin-bottom-30">
                    ...
                    <p>Join the TechSistars Mentorship Program and take the first step toward transforming your future in technology and entrepreneurship.</p>
                </div>
                <div class="col-lg-6 margin-bottom-30">
    ...
    <div class="row">
      ...
      <div class="col-lg-5" data-aos="fade-up">
        ...
        <p class="faq-description">
          Here are some of the most common questions about TechsiStars.  
          If you don’t find your answer, feel free to reach out to us.
        </p>
      ...
      <div class="col-lg-7" data-aos="fade-up" data-aos-delay="300">
        <div class="faq-container">
          ...
          <div class="faq-item faq-active">
            <h3>What is TechsiStars?</h3>
            <div class="faq-content">
              <p>TechsiStars is a women-focused initiative empowering young women and female-led businesses with digital skills, mentorship, and entrepreneurial support.</p>
            </div>
          ...
          <div class="faq-item">
            <h3>Who can apply?</h3>
            <div class="faq-content">
              <p>The program is open to women, innovators, and entrepreneurs who want to grow their businesses, careers, and leadership through technology and innovation.</p>
            </div>
            <i class="faq-toggle bi bi-chevron-right"></i>
          </div><!-- End Faq item-->

          <div class="faq-item">
            <h3>What kind of support will I get?</h3>
            <div class="faq-content">
              <p>Participants receive hands-on training, mentorship, networking opportunities, and access to resources that support growth, innovation, and sustainability.</p>
            </div>
            <i class="faq-toggle bi bi-chevron-right"></i>
          </div><!-- End Faq item-->

          <div class="faq-item">
            <h3>Is TechsiStars free?</h3>
            <div class="faq-content">
              <p>Yes! Selected participants benefit from free training and mentorship, supported by our partners and sponsors.</p>
            </div>
            <i class="faq-toggle bi bi-chevron-right"></i>
          </div><!-- End Faq item-->

          <div class="faq-item">
            <h3>How does TechsiStars create impact?</h3>
            <div class="faq-content">
              <p>By equipping women with digital and entrepreneurial skills, TechsiStars drives innovation, fosters job creation, and strengthens communities.</p>
            </div>
            <i class="faq-toggle bi bi-chevron-right"></i>
          </div><!-- End Faq item-->
          ...
          <div class="faq-item">
            ...
            <div class="faq-content">
              <p>Graduates join the TechsiStars alumni network, gaining continuous mentorship, collaborations, and access to opportunities for scaling their businesses or careers.</p>
            </div>
            <i class="faq-toggle bi bi-chevron-right"></i>
          </div><!-- End Faq item-->
