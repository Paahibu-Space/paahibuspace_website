    ...
    <div class="container aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
        <div class="row gy-4">
            <div class="col-lg-6 order-1 order-lg-2">
                <img src="{{ asset('assets/frontend/images/program/techsistars.png') }}" class="img-fluid" alt="TechsiStars Program">
            </div>
        ...
        <div class="row align-items-center justify-content-center">
            <div class="col-lg-6 col-md-8">
                <div class="about__img-wrap-six">
                    <img src="{{ asset('assets/frontend/images/program/techsistars-need.png') }}"
                        data-bb-lazy="true" loading="lazy"
                        data-src="{{ asset('assets/frontend/images/program/techsistars-need.png') }}"
        ...
        <div class="row align-items-center justify-content-center">
            ...
            <div class="col-lg-6 col-md-9 margin-bottom-30">
                <div class="choose__img-wrap-five">
                    <img src="{{ asset('assets/frontend/images/program/techsistars-objectives.png') }}"
                        data-bb-lazy="true" loading="lazy"
                        data-src="{{ asset('assets/frontend/images/program/techsistars-objectives.png') }}"
