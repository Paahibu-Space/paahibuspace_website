        ...
        <div class="container aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-6 order-2 order-lg-1 content">
                    ...
                    <p class="fst-italic">
                        A 5-week online initiative dedicated to facilitating the growth, development, profitability and
                        sustainability of women-owned businesses.
                    </p>
                    <h5 class="fw-bold">Participants gain:</h5>
                    <ul class="program-components">
                        <li><i class="bi bi-check2-all"></i> <span>Practical understanding of AI applications in
                                business</span></li>
                        <li><i class="bi bi-check2-all"></i> <span>Enhanced storytelling skills to connect with
                                customers</span></li>
                        <li><i class="bi bi-check2-all"></i> <span>Strategies for building a strong brand identity</span>
                        </li>
                        <li><i class="bi bi-check2-all"></i> <span>Networking opprotunities with fellow women
                                entrepreneurs</span></li>
                    </ul>
                    <p>
                        <span class="fw-bold">WiDEI</span> is our commitment to gender equality. We create awareness on digital literacy for women-led
                        businesses in the informal sector and women in rural and marginalized communities. Partnering with
                        digital platforms, we bring financial solutions, online markets, social media visibility and more to
                        uplift communities.
                    </p>
                </div>
            </div>
            ...
            <div class="row align-items-center justify-content-center">
                ...
                <div class="col-lg-6">
                    <div class="about__content-six">
                        ...
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Deleniti commodi modi, eveniet, aspernatur ullam, iusto magnam </p>
                        <div class="about__content-inner-four">
                            <div class="about__list-box">
                                <ul class="list-wrap">
                                    <li><i class="bi bi-arrow-right"></i>Women: 25% of the global workforce</li>
                                    <li><i class="bi bi-arrow-right"></i>Women: Hold only 11% of the senior management positions globally</li>
                                </ul>
                            </div>
            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-6 margin-bottom-30">
                    <div class="choose__content-five">
                        ...
                        <p>WiDEI is dedicated to fostering the growth, development, and sustainability of women-owned businesses. By empowering women with essential digital skills, we aim to bridge the gender gap in the digital economy and uplift underserved communities.</p>
                                ...
                                <div class="col-sm-6">
                                    <div class="choose__box">
                                        ...
                                        <div class="content">
                                            ...
                                            <p>Increase the digital literacy rate among women in rural and marginalized communities, enabling them to leverage technology for business growth.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="choose__box">
                                        ...
                                        <div class="content">
                                            ...
                                            <p>Enhance access to financial solutions and online marketplaces, driving profitability and sustainability for women-owned businesses.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-5" data-aos="fade-up">
        ...
        <p class="faq-description">
          Here are some frequently asked questions about the Women in Digital Economy Initiative (WiDEI).
        </p>
        ...
        <div class="faq-container">
          ...
          <div class="faq-item faq-active">
            ...
            <div class="faq-content">
              <p>The Women in Digital Economy Initiative (WiDEI) empowers women and girls with digital skills, entrepreneurship training, and mentorship to thrive in today’s economy.</p>
            </div>
            <i class="faq-toggle bi bi-chevron-right"></i>
          </div><!-- End Faq item-->

          <div class="faq-item">
            <h3>Who can participate in WiDEI?</h3>
            <div class="faq-content">
              <p>WiDEI is open to women and girls, especially those from underserved communities, who are interested in gaining digital skills and building entrepreneurial capacity.</p>
            </div>
            <i class="faq-toggle bi bi-chevron-right"></i>
          </div><!-- End Faq item-->

          <div class="faq-item">
            <h3>What does the program cover?</h3>
            <div class="faq-content">
              <p>The program includes training in digital literacy, financial inclusion, business development, mentorship, and access to networks that foster women-led innovation.</p>
            </div>
            <i class="faq-toggle bi bi-chevron-right"></i>
          </div><!-- End Faq item-->
          ...
          <div class="faq-item">
            <h3>Is WiDEI free?</h3>
            <div class="faq-content">
              <p>Yes, WiDEI provides free training and mentorship opportunities, supported by partnerships with organizations and community stakeholders.</p>
            </div>
            <i class="faq-toggle bi bi-chevron-right"></i>
          </div><!-- End Faq item-->

          <div class="faq-item">
            <h3>How does WiDEI create impact?</h3>
            <div class="faq-content">
              <p>By equipping women with digital and entrepreneurial skills, WiDEI enables them to build businesses, access better opportunities, and contribute to economic growth.</p>
            </div>
            <i class="faq-toggle bi bi-chevron-right"></i>
          </div><!-- End Faq item-->

          <div class="faq-item">
            <h3>What happens after completing WiDEI?</h3>
            <div class="faq-content">
              <p>Graduates join the WiDEI alumni network, where they continue receiving mentorship, networking, and access to opportunities for scaling their businesses or careers.</p>
            </div>
            <i class="faq-toggle bi bi-chevron-right"></i>
          </div><!-- End Faq item-->
