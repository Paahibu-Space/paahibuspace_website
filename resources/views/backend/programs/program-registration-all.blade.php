                                ...
                                <div class="card-body">
                                    ...
                                    <div class="data-tables datatable-primary table-responsive">
                                        <table id="all_user_table" >
                                            ...
                                            <tbody>
                                            @foreach($all_registration as $data)
                                                <tr>
                                                    <td>
    ...
    <div class="modal fade" id="user_edit_modal" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="{{route('admin.program.registration.send.mail')}}" method="post" enctype="multipart/form-data">
                    @csrf
    ...
    <div class="modal fade" id="order_status_change_modal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                @endif
                <form action="{{route('admin.program.registration.logs')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        <input type="hidden" name="registration_id" id="order_id">
                        <div class="form-group">
                            <label for="order_status">{{__('Attendance Status')}}</label>
                            <select name="registration_status" class="form-control" id="order_status">
        ...
        $(document).ready(function() {
            ...
            $(document).on('click','#bulk_delete_btn',function (e) {
                ...
                if(allIds != '' && bulkOption == 'delete'){
                    ...
                    $.ajax({
                        'type' : "POST",
                        'url' : "{{route('admin.program.registration.bulk.action')}}",
                        'data' : {
                            _token: "{{csrf_token()}}",
                            ids: allIds
                        },
