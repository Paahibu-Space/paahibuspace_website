                    ...
                    <div class="card-body">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            @foreach($all_category as $key => $slider)
                                <li class="nav-item">
                                    <a class="nav-link @if($a == 0) active @endif"  data-toggle="tab" href="#slider_tab_en_US" role="tab" aria-controls="home" aria-selected="true">English</a>
                                </li>
                                @php $a++; @endphp
                            @endforeach
                        </ul>
                        <div class="tab-content margin-top-40" id="myTabContent">
                            ...
                            @foreach($all_category as $key => $category)
                                <div class="tab-pane fade @if($b == 0) show active @endif" id="slider_tab_en_US" role="tabpanel" >
            ...
            <div class="col-lg-5 mt-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.team.category')}}" method="post" enctype="multipart/form-data">
                            @csrf
    ...
    <div class="modal fade" id="category_edit_modal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{route('admin.team.category.update')}}"  method="post">
